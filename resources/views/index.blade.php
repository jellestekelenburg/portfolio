        ...
        <div class="lg:py-40 py-24 border-x-1 border-white/5 relative">
            ...
            <div class="lg:w-3/5 px-2">
                <h1 class="text-5xl text-white">I <span
                        class="text-red-500 italic">build</span>
                    & <span
                        class="text-red-500 italic">design</span>
...
<section>
    <div class="container">
        <div class="grid lg:grid-cols-2  border-1 border-white/5 relative">
            ...
            <div class="p-10">
                <svg class="size-16 fill-red-500" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 640 640"><path d="M288 64L288 144L352 144L352 64L448 64L448 272L192 272L192 64L288 64zM576 576L368 576L368 320L416 320L416 400L480 400L480 320L576 320L576 576zM320 320L320 576L64 576L64 320L160 320L160 400L224 400L224 320L320 320z"/></svg>
